...
const Login = () => {
  ...
  return (
    <div style={{
      ...
      {/* Ambient glows */}
      <div style={{ position: 'absolute', top: '-100px', right: '-100px', width: '500px', height: '500px', background: 'radial-gradient(circle,rgba(124,58,237,0.1) 0%,transparent 70%)', pointerEvents: 'none' }} />
      <div style={{ position: 'absolute', bottom: '-100px', left: '-100px', width: '400px', height: '400px', background: 'radial-gradient(circle,rgba(168,85,247,0.07) 0%,transparent 70%)', pointerEvents: 'none' }} />
      ...
      <div style={{ width: '100%', maxWidth: '400px', position: 'relative', zIndex: 1 }} className="fade-in">
        ...
        <div style={{ textAlign: 'center', marginBottom: '36px' }}>
          ...
          <p style={{ color: 'rgba(255,255,255,0.35)', fontSize: '13px' }}>Sign in to your workspace</p>
        </div>
        ...
        <div style={{
          ...
          <h2 style={{ fontSize: '18px', fontWeight: 700, color: '#F0EEFF', marginBottom: '22px' }}>Welcome back 👋</h2>
          ...
          <p style={{ textAlign: 'center', marginTop: '22px', fontSize: '13px', color: 'rgba(255,255,255,0.3)' }}>
            ...
            <Link to="/signup" style={{ color: '#A78BFA', fontWeight: 600 }}>Sign up</Link>
          </p>
        </div>
      </div>
    </div>
